...
int main(void)
{
	...
	binary_search(search_values, search_items, 1.925);
	binary_search(search_values, search_items, 200.001);
	binary_search(search_values, search_items, 25.555);
	int i;
	for(i=0; i < search_items - 1; i++) 
	{
		printf("%lf asd , %d\n", search_values[i], search_items);
	}
	/*********************************************************************/
