...
#include "sqroot.h"		// needed for clock()
...
{
	int i;
	   //Student code from the exercise05
	struct Result res = TimeDecorator(sqroot, 2);
	
	double new_guess = res.sqr;
	double elapsed = res.spentTime;
