...
int main(void)
{
	...
	// Put the code here that computes the square root of two.  The result
	// of the computation should be stored in the variable new_guess.
	double new_guess = sqrt(2);	// replace this line with your code
	/******************** Student's code goes here ***********************/
